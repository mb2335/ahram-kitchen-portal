...
const englishTranslations = {
  ...
  'checkout.error.timeSlot': 'Please select a delivery time slot',
  'checkout.delivery.error.noTimeSlots': 'No delivery time slots available for this date. Please select another date.',
...
const koreanTranslations = {
  ...
  'checkout.categories.methods': '카테고리별 배달 방법',
  ...
  'checkout.error.timeSlot': '배송 시간대를 선택해주세요',
  'checkout.delivery.error.noTimeSlots': '이 날짜에 이용 가능한 배송 시간이 없습니다. 다른 날짜를 선택해주세요.',
